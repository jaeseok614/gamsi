...
import { buildScheduleOperationPlan, type ScheduleOperationBody, type ScheduleOperationMode } from "@/lib/schedule-operations";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return jsonError(error instanceof Error ? error.message : "스케줄 미리보기에 실패했습니다.");
  }
}
